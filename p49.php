<?php   
   ...
   session_start();
       ...
       $question = "Exercise";
       $answerText = "How regularly do you engage in physical exercise (30 minutes or more)? ";
       $answerValue = isset($_POST['exercise']) ? intval($_POST['exercise']) : null;
       ...
       if ($answerValue !== null) {
           ...
           if ($result) {
               ...
               header("Location: p50.php?score=" . $totalScore);
               exit();
           } else {
...
<body>
    <div class="container">
        ...
        <div class="question">
        <span>How regularly do you engage in physical exercise (30 minutes or more)? </span><br>
    </b>
            <form action="<?php echo $_SERVER['PHP_SELF'] . '?score=' . $previousScore; ?>" method="post" onsubmit="return validateForm()">
            
            <label><input type="radio" name="exercise" value="1" class="answer"> A. Every day</label><br>
        <label><input type="radio" name="exercise" value="2" class="answer"> B. Few days a week</label><br>
        <label><input type="radio" name="exercise" value="3" class="answer"> C. Once a week</label><br>
        <label><input type="radio" name="exercise" value="4" class="answer"> D. Less than once a week</label><br>
        <label><input type="radio" name="exercise" value="5" class="answer"> E. Rarely/Never</label><br>
