...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $answerText = "Your ability to bounce back and restore your emotional balance after setbacks";
    ...
    if ($answerValue !== null) {
        ...
        if ($result) {
            ...
            header("Location: p12.php?score=" . $totalScore);
            exit();
        } else {
            echo "Error: " . $sql . "<br>" . mysqli_error($con);
        }
    } else {
        echo "Please select a value for emotional resilience.";
    }
...
<body>
    <div class="container">
        ...
        <div class="question">
            <span><b>Assess your: Emotional Resilience</b><br>
               <i>"Your ability to bounce back and restore your emotional balance after setbacks"</i><br>
