<?php   
   ...
   session_start();
       ...
       $question = "socialize";
       $answerText = "How regularly do you socialize with friends in person?";
       
       $answerValue = isset($_POST['socialize']) ? intval($_POST['socialize']) : null;
       ...
       if ($answerValue !== null) {
           ...
           if ($result) {
               ...
               header("Location: p54.php?score=" . $totalScore);
               exit();
           } else {
...
<body>
    <div class="container">
        ...
        <div class="question">
        <span>How regularly do you socialize with friends in person?</span><br></b>
     
            <form action="<?php echo $_SERVER['PHP_SELF'] . '?score=' . $previousScore; ?>" method="post" onsubmit="return validateForm()">
            <label><input type="radio" name="socialize" value="1" class="answer"> A. Several days a week</label><br>
        <label><input type="radio" name="socialize" value="2" class="answer"> B. Once a week</label><br>
        <label><input type="radio" name="socialize" value="3" class="answer"> C. 1-3 times a month</label><br>
        <label><input type="radio" name="socialize" value="4" class="answer"> D. Rarely/Never</label><br>
