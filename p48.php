<?php   
   ...
   session_start();
       ...
       $question = "sleep";
       $answerText = "In general, I get as much sleep as I need:";
       ...
       if ($answerValue !== null) {
           ...
           if ($result) {
               ...
               header("Location: p49.php?score=" . $totalScore);
               exit();
           } else {
...
<body>
    <div class="container">
        ...
        <div class="question">
        <span> <b>In general, I get as much sleep as I need:</b></span><br>
            <form action="<?php echo $_SERVER['PHP_SELF'] . '?score=' . $previousScore; ?>" method="post" onsubmit="return validateForm()">
            
            <label><input type="radio" name="sleep" value="1" class="answer"> A. All of the time</label><br>
            <label><input type="radio" name="sleep" value="2" class="answer"> B. Most of the time</label><br>
            <label><input type="radio" name="sleep" value="3" class="answer"> C. Some of the time</label><br>
            <label><input type="radio" name="sleep" value="4" class="answer"> D. Hardly ever</label><br>
